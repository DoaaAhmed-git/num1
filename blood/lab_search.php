...
if(isset($_POST['submit'])){
  ...
  $query= "select * from blood_request  where hospital like '%$search%' ";
...
"<td style='direction:rtl;' class='text-right'>"."<a  href='lab4.php?search={$dude} &id={$_SESSION['request']}  '><button class='btn btn-success'> مطابقة </button></a></td></tr>";
