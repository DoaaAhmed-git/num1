...
//$_SESSION['jop_type'] = $db_jop;
     ...
     echo '<script type="text/javascript"> location.replace("doctor1.php"); </script>';
...
echo '<script type="text/javascript"> location.replace("lab1.php"); </script>';
...
echo '<script type="text/javascript"> location.replace("hamlat2.php"); </script>';
...
echo '<script type="text/javascript"> location.replace("moshref.php"); </script>';
