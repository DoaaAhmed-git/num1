...
$query = "SELECT * FROM blood_request  where blood_ty = 'A-'";
...
$result = mysqli_query($conn,$query);
 ...
 $query = "SELECT * FROM blood_request where blood_ty = 'B+'";
$result = mysqli_query($conn,$query);
...
$result = mysqli_query($conn,$query);
 ...
 $query = "SELECT * FROM blood_request  where blood_ty = 'O+'";
$result = mysqli_query($conn,$query);
...
$result = mysqli_query($conn,$query);
 ...
 $query = "SELECT * FROM blood_request where blood_ty = 'AB+'";
$result = mysqli_query($conn,$query);
...
//-------------------------------------------------------------
 ...
 $query = "SELECT * FROM blood_request where blood_type = 'Plazma'";
$result = mysqli_query($conn,$query);

 $post_number9 = mysqli_num_rows($result);



 $query = "SELECT * FROM blood_request where blood_type = 'Red blood'";
$result = mysqli_query($conn,$query);

 $post_number10 = mysqli_num_rows($result);


 $query = "SELECT * FROM blood_request where blood_type = 'Platelets'";
$result = mysqli_query($conn,$query);

 $post_number11 = mysqli_num_rows($result);
...
<div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">تقرير طلبات المستشفيات</h6>
                </div>
                <div class="card-body">
                  <p>تقرير طلبات المستشفات يوضح الفصائل الاكثر طلبا و الاقل طلبا </p>
                  <p class="mb-0"></p>
                </div>
              </div>
        ...
        <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">طلب الدم حسب الفصائل</h6>
                </div>
