...
<div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">تقرير الفصائل</h6>
                </div>
                <div class="card-body">
                  <p>تقرير الفصائل .. يعرفك على مدى توفر الفصائل و قلتها في المعمل  عن طريق مخطط بياني </p>
                  <p class="mb-0"></p>
                </div>
              </div>
        ...
        <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">توفر الدم حسب الفصائل</h6>
                </div>
...
<script type="text/javascript" src="js/jquery-3.4.1.min.js"></script>
  ...
  <script type="text/javascript">
    ...
    var val22 = "<?php  '<a  href="lab.php"></a>' ?> ";
