...
<div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">تقرير المتبرعين</h6>
                </div>
                <div class="card-body">
                  <p>يصنف تقرير المتبرعين اعدادهم حسب الجنس من زكور و اناث </p>
                  <p class="mb-0"></p>
                </div>
              </div>
        ...
        <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">المتبرعين حسب الجنس</h6>
                </div>
