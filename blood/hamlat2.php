        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto" style="float:right;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="hamlat2.php" target="_blank"><i> اضافة حملة</i> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" target="_blank"><i> اعلان حملة</i>
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 text-right" style="margin-top:-190px;">
            ...
            <form class="text-center border border-light p-5" action=" " method="post">
                ...
                <samp class="h4 mb-4 text-right" style="margin-top:-20px;"> <i>اعلان حملة 
                </samp></i>
                <div style="margin-top:40px;">
                    <div class="row" style="margin-top:20px;">
                        ...
                        <!-- Name -->
                        <div class="col-lg-9">
                            <input type="text" style="direction:rtl" class="form-control mb-4 text-right" name="place">
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <!-- Name -->
                        <div class="col-lg-9">
                            <input type="text" style="direction:rtl" class="form-control mb-4 text-right" name="car">
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <!-- Name -->
                        <div class="col-lg-9">
                            <input type="date" style="direction:rtl"  class="form-control mb-4 text-right" name="date" >
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <!-- Name -->
                        <div class="col-lg-8">
                            <input type="text" style="direction:rtl"  class="form-control mb-4 text-right" name="doctor">
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <!-- Name -->
                        <div class="col-lg-8">
                            <input type="text" style="direction:rtl"  class="form-control mb-4 text-right" name="nurse">
                        </div>
                        <div class="col-lg-4">
                   ...
                   <div class="row">
                    <div class="col-lg-8">
                            <textarea style="direction:rtl"  class="form-control mb-4 text-right" name="khabr"></textarea>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <button class="btn btn-info btn-block" type="submit" style="margin-top:-10px;" name="create">تسجيل</button>
                </div>
