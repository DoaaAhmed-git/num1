...
<div class="card shadow mb-4" style="direction: rtl;">
                <div class="card-header row">
                  <h6 class="m-0 font-weight-bold text-primary" style="direction: rtl;">تعرف على اخر الحملات</h6>
                </div>
                <div class="card-body row" >
                  <p style="direction: rtl;">تظهر هنا اخبار الحملات  و بعض التفاصيل عنها.. شارك في موقع الحملات او اخبر شخص قريب :) 
                  . </p>
                  <p class="mb-0"></p>
                </div>
              </div>
...
//error_reporting(0);
 ...
 $as = "SELECT * FROM  combaigin ORDER BY `id` DESC";
...
echo "<div class='container'>".
 ...
 "$do"."<br>".
 "<hr class='my-7' size='5'>".
 "<b>"."مكان الحملة" ."</b>"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp".
 "$do6". 
 "<br>" ."<b>"."دكتور الحملة"."</b>"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp".
 "$do4".

 " <br>" 
 ."<b>" ."ممرض الحملة" ."</b>"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp".
 "$do5".
 "<br>" ."<b>". "تاريخ الحملة" ."</b>"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp"."&nbsp". 
 "$do3"
 ."</p>".
