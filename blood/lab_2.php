            ...
            <form class="text-center border border-light p-5" action="#!" method="POST">
                ...
                <div style="margin-top:40px;">
                    <div class="row" style="margin-top:20px;">
                        ...
                        <!-- Name -->
                        <div class="col-lg-9">
                            <input type="text" style="direction:rtl" class="form-control mb-4 text-right" name="fr">
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <!-- Name -->
                        <div class="col-lg-4">
                            <select style="direction:rtl"  class="form-control mb-4 text-right" name="typ">
                                <option> </option>
                    ...
                    <div class="row">
                        ...
                        <!-- Name -->
                        <div class="col-lg-9">
                            <input type="text" style="direction:rtl"  class="form-control mb-4 text-right" name="size">
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <!-- Name -->
                        <div class="col-lg-9">
                            <input type="text" style="direction:rtl"  class="form-control mb-4 text-right" name="tar">
                        </div>
                        <div class="col-lg-3">
