          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="" enctype="multipart/form-data" >
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label"  >Event Price</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label"  >Add Photo</label>
                  <div class="col-sm-10">
...
if (!empty($monasaba) && !empty($topic) && !empty($filename) && !empty($hall)) {
 


$query = " INSERT INTO event ( name , price , potho , message ) values ('$monasaba' , '$topic' , '$filename' , '$hall') ";
...
echo "<script>alert('Sucssecfully adding Event') </script>";
