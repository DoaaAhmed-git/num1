...
include 'header.html';
 ...
 <section class="section">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Update ab about us</h5>
              ...
              <form method="POST" action="" enctype="multipart/form-data" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="go">UPDATE</button>
                  </div>
                </div>
...
if (!empty($filename) && !empty($hall)) {
 


$query = " INSERT INTO about (photo, message ) values ( '$filename' , '$hall') ";
...
echo "<script>alert('Sucssecfully Updating about us') </script>";
